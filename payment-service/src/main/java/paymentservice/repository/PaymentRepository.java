...
public interface PaymentRepository extends MongoRepository<Payment, String> {
    ...
    List<Payment> findByTimestampBetweenAndStatus(Instant from, Instant to, PaymentStatus status);

    List<Payment> findByUserIdAndTimestampBetweenAndStatus(Long userId, Instant from, Instant to, PaymentStatus status);
